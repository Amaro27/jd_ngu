...
class EstacionamientoApp:
    ...
    def actualizar_secciones_display(self):
        ...
        for seccion in self.secciones:
            seccion_text = f"{seccion['nombre']} - {seccion['ancho']}x{seccion['largo']} m - Cajones: {seccion['cajones']}"
        ...
        try:
            ...
            with open(filename, "w") as f:
                ...
                for seccion in self.secciones:
                    ...
                    f.write(f"- Nombre: {seccion['nombre']}, Dimensiones: {seccion['ancho']}x{seccion['largo']} m, Area: {seccion['area']} m2, Cajones: {seccion['cajones']}, Productos: {productos}\n")
